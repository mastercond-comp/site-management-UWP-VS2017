...
namespace Управление.сайтом
{
    ...
    public sealed partial class Clients : Page
    {
        ...
        private async void LoadFileTCatalog_Click(object sender, RoutedEventArgs e)
        {
            ...
            picker.FileTypeFilter.Add(".ourclients");
        ...
        private async void SaveFileKatalogTovarov_Click(object sender, RoutedEventArgs e)
        {
            ...
            savePicker4.FileTypeChoices.Add("Файл данных модуля \"НАШИ КЛИЕНТЫ\" ", new List<string>() { ".ourclients" });
            // Default file name if the user does not type one in or select a file to replace
            savePicker4.SuggestedFileName = "clients";
            //
            ...
            if (Myfile4 != null)
            {
                ...
                if (status == Windows.Storage.Provider.FileUpdateStatus.Complete)
                {
                    ...
                    this.StatusFile.Text = "Файл данных модуля \"НАШИ КЛИЕНТЫ\" " + Myfile4.Name + " успешно сохранен.";
                    Progress.IsActive = false;

                    var messagedialog = new MessageDialog("Файл данных модуля \"НАШИ КЛИЕНТЫ\" " + Myfile4.Name + " успешно сохранен.");
                    messagedialog.Commands.Add(new UICommand("Ok"));
                    await messagedialog.ShowAsync();
                }
                else
                {
                    this.StatusFile.Text = "Не удалось сохранить файл данных модуля \"НАШИ КЛИЕНТЫ\" " + Myfile4.Name + ".";
                    Progress.IsActive = false;

                    var messagedialog = new MessageDialog("Не удалось сохранить файл данных модуля \"НАШИ КЛИЕНТЫ\" " + Myfile4.Name + ".");
                    messagedialog.Commands.Add(new UICommand("Ok"));
                    await messagedialog.ShowAsync();
                }
            }
            ...
            {
                this.StatusFile.Text = "Операция записи файла данных модуля \"НАШИ КЛИЕНТЫ\" была прервана.";
                Progress.IsActive = false;

                var messagedialog = new MessageDialog("Операция записи файла данных модуля \"НАШИ КЛИЕНТЫ\" была прервана.");
                messagedialog.Commands.Add(new UICommand("Ok"));
                await messagedialog.ShowAsync();
            }
            Progress.IsActive = false;
        ...
        private async void SaveFileKatalogTovarovTPL_Click(object sender, RoutedEventArgs e)
        {
            ...
            savePicker4.SuggestedStartLocation = Windows.Storage.Pickers.PickerLocationId.DocumentsLibrary;
            // Поле выбора типа файла в диалоге
            savePicker4.FileTypeChoices.Add("TPL файл модуля \"НАШИ КЛИЕНТЫ\" ", new List<string>() { ".tpl" });
            // Default file name if the user does not type one in or select a file to replace
            savePicker4.SuggestedFileName = "clients";
            //
            Windows.Storage.StorageFile Myfile4 = await savePicker4.PickSaveFileAsync();
            if (Myfile4 != null)
            {
                ...
                await FileIO.WriteTextAsync(Myfile4, "<!-- ======================================МОДУЛЬ \"НАШИ КЛИЕНТЫ\"======================================== -->\r\n");
                await FileIO.AppendTextAsync(Myfile4, "<div class=\"container marketing\"><h3 style=\"color:" + TextBoxZagolovokColor.Text + ";\">НАШИ КЛИЕНТЫ</h3>\r\n");
                ...
                if (TextBoxZagolovok1.Text.Length != 0 | TextBoxZagolovok2.Text.Length != 0 | TextBoxZagolovok3.Text.Length != 0 | TextBoxZagolovok4.Text.Length != 0)
                {
                    ...
                    {
                        await FileIO.AppendTextAsync(Myfile4, "<div class=\"col-xs-6 col-md-3\">\r\n<div class=\"clients-image\"><img class=\"img-responsive\" src=\"" + TextBoxIMGLink1.Text + "\" alt=\"" + TextBoxZagolovok1.Text + "\">\r\n</div><div class=\"clients-text\"><h4 class=\"clients\">" + TextBoxZagolovok1.Text + "</h4>\r\n<p class=\"clients\">" + TextBoxOpisanie1.Text + "</p>\r\n</div></div><!-- /.col-lg-4 -->\r\n");
                    }

                    if (TextBoxZagolovok2.Text.Length != 0)
                    {
                        await FileIO.AppendTextAsync(Myfile4, "<div class=\"col-xs-6 col-md-3\">\r\n<div class=\"clients-image\"><img class=\"img-responsive\" src=\"" + TextBoxIMGLink2.Text + "\" alt=\"" + TextBoxZagolovok2.Text + "\">\r\n</div><div class=\"clients-text\"><h4 class=\"clients\">" + TextBoxZagolovok2.Text + "</h4>\r\n<p class=\"clients\">" + TextBoxOpisanie2.Text + "</p>\r\n</div></div><!-- /.col-lg-4 -->\r\n");
                    }

                    if (TextBoxZagolovok3.Text.Length != 0)
                    {
                        await FileIO.AppendTextAsync(Myfile4, "<div class=\"col-xs-6 col-md-3\">\r\n<div class=\"clients-image\"><img class=\"img-responsive\" src=\"" + TextBoxIMGLink3.Text + "\" alt=\"" + TextBoxZagolovok3.Text + "\">\r\n</div><div class=\"clients-text\"><h4 class=\"clients\">" + TextBoxZagolovok3.Text + "</h4>\r\n<p class=\"clients\">" + TextBoxOpisanie3.Text + "</p>\r\n</div></div><!-- /.col-lg-4 -->\r\n");
                    }

                    if (TextBoxZagolovok4.Text.Length != 0)
                    {
                        await FileIO.AppendTextAsync(Myfile4, "<div class=\"col-xs-6 col-md-3\">\r\n<div class=\"clients-image\"><img class=\"img-responsive\" src=\"" + TextBoxIMGLink4.Text + "\" alt=\"" + TextBoxZagolovok4.Text + "\">\r\n</div><div class=\"clients-text\"><h4 class=\"clients\">" + TextBoxZagolovok4.Text + "</h4>\r\n<p class=\"clients\">" + TextBoxOpisanie4.Text + "</p>\r\n</div></div><!-- /.col-lg-4 -->\r\n");
                    }
                ...
                if (TextBoxZagolovok5.Text.Length != 0 | TextBoxZagolovok6.Text.Length != 0 | TextBoxZagolovok7.Text.Length != 0 | TextBoxZagolovok8.Text.Length != 0)
                {
                    ...
                    {
                        await FileIO.AppendTextAsync(Myfile4, "<div class=\"col-xs-6 col-md-3\">\r\n<div class=\"clients-image\"><img class=\"img-responsive\" src=\"" + TextBoxIMGLink5.Text + "\" alt=\"" + TextBoxZagolovok5.Text + "\">\r\n</div><div class=\"clients-text\"><h4 class=\"clients\">" + TextBoxZagolovok5.Text + "</h4>\r\n<p class=\"clients\">" + TextBoxOpisanie5.Text + "</p>\r\n</div></div><!-- /.col-lg-4 -->\r\n");
                    }

                    if (TextBoxZagolovok6.Text.Length != 0)
                    {
                        await FileIO.AppendTextAsync(Myfile4, "<div class=\"col-xs-6 col-md-3\">\r\n<div class=\"clients-image\"><img class=\"img-responsive\" src=\"" + TextBoxIMGLink6.Text + "\" alt=\"" + TextBoxZagolovok6.Text + "\">\r\n</div><div class=\"clients-text\"><h4 class=\"clients\">" + TextBoxZagolovok6.Text + "</h4>\r\n<p class=\"clients\">" + TextBoxOpisanie6.Text + "</p>\r\n</div></div><!-- /.col-lg-4 -->\r\n");
                    }

                    if (TextBoxZagolovok7.Text.Length != 0)
                    {
                        await FileIO.AppendTextAsync(Myfile4, "<div class=\"col-xs-6 col-md-3\">\r\n<div class=\"clients-image\"><img class=\"img-responsive\" src=\"" + TextBoxIMGLink7.Text + "\" alt=\"" + TextBoxZagolovok7.Text + "\">\r\n</div><div class=\"clients-text\"><h4 class=\"clients\">" + TextBoxZagolovok7.Text + "</h4>\r\n<p class=\"clients\">" + TextBoxOpisanie7.Text + "</p>\r\n</div></div><!-- /.col-lg-4 -->\r\n");
                    }

                    if (TextBoxZagolovok8.Text.Length != 0)
                    {
                        await FileIO.AppendTextAsync(Myfile4, "<div class=\"col-xs-6 col-md-3\">\r\n<div class=\"clients-image\"><img class=\"img-responsive\" src=\"" + TextBoxIMGLink8.Text + "\" alt=\"" + TextBoxZagolovok8.Text + "\">\r\n</div><div class=\"clients-text\"><h4 class=\"clients\">" + TextBoxZagolovok8.Text + "</h4>\r\n<p class=\"clients\">" + TextBoxOpisanie8.Text + "</p>\r\n</div></div><!-- /.col-lg-4 -->\r\n");
                    }
                ...
                if (TextBoxZagolovok9.Text.Length != 0 | TextBoxZagolovok10.Text.Length != 0 | TextBoxZagolovok11.Text.Length != 0 | TextBoxZagolovok12.Text.Length != 0)
                {
                    ...
                    {
                        await FileIO.AppendTextAsync(Myfile4, "<div class=\"col-xs-6 col-md-3\">\r\n<div class=\"clients-image\"><img class=\"img-responsive\" src=\"" + TextBoxIMGLink9.Text + "\" alt=\"" + TextBoxZagolovok9.Text + "\">\r\n</div><div class=\"clients-text\"><h4 class=\"clients\">" + TextBoxZagolovok9.Text + "</h4>\r\n<p class=\"clients\">" + TextBoxOpisanie9.Text + "</p>\r\n</div></div><!-- /.col-lg-4 -->\r\n");
                    }

                    if (TextBoxZagolovok10.Text.Length != 0)
                    {
                        await FileIO.AppendTextAsync(Myfile4, "<div class=\"col-xs-6 col-md-3\">\r\n<div class=\"clients-image\"><img class=\"img-responsive\" src=\"" + TextBoxIMGLink10.Text + "\" alt=\"" + TextBoxZagolovok10.Text + "\">\r\n</div><div class=\"clients-text\"><h4 class=\"clients\">" + TextBoxZagolovok10.Text + "</h4>\r\n<p class=\"clients\">" + TextBoxOpisanie10.Text + "</p>\r\n</div></div><!-- /.col-lg-4 -->\r\n");
                    }

                    if (TextBoxZagolovok11.Text.Length != 0)
                    {
                        await FileIO.AppendTextAsync(Myfile4, "<div class=\"col-xs-6 col-md-3\">\r\n<div class=\"clients-image\"><img class=\"img-responsive\" src=\"" + TextBoxIMGLink11.Text + "\" alt=\"" + TextBoxZagolovok11.Text + "\">\r\n</div><div class=\"clients-text\"><h4 class=\"clients\">" + TextBoxZagolovok11.Text + "</h4>\r\n<p class=\"clients\">" + TextBoxOpisanie11.Text + "</p>\r\n</div></div><!-- /.col-lg-4 -->\r\n");
                    }

                    if (TextBoxZagolovok12.Text.Length != 0)
                    {
                        await FileIO.AppendTextAsync(Myfile4, "<div class=\"col-xs-6 col-md-3\">\r\n<div class=\"clients-image\"><img class=\"img-responsive\" src=\"" + TextBoxIMGLink12.Text + "\" alt=\"" + TextBoxZagolovok12.Text + "\">\r\n</div><div class=\"clients-text\"><h4 class=\"clients\">" + TextBoxZagolovok12.Text + "</h4>\r\n<p class=\"clients\">" + TextBoxOpisanie12.Text + "</p>\r\n</div></div><!-- /.col-lg-4 -->\r\n");
                    }

                    await FileIO.AppendTextAsync(Myfile4, "</div><!-- /.row -->\r\n<!-- КОНЕЦ ЧЕТЫРЕ ЭЛЕМЕНТА В ОДНОЙ СТРОКЕ -->\r\n");
                }

                await FileIO.AppendTextAsync(Myfile4, "</div>\r\n<!-- ======================================КОНЕЦ МОДУЛЯ \"НАШИ КЛИЕНТЫ\"======================================== -->\r\n");
                ...
                if (status == Windows.Storage.Provider.FileUpdateStatus.Complete)
                {
                    ...
                    var messagedialog = new MessageDialog("PHP-файл страницы \"НАШИ КЛИЕНТЫ\" " + Myfile4.Name + " успешно экспортирован.");
                    messagedialog.Commands.Add(new UICommand("Ok"));
                    await messagedialog.ShowAsync();
                }
                else
                {
                    ...
                    var messagedialog = new MessageDialog("Не удалось сохранить PHP-файл страницы \"НАШИ КЛИЕНТЫ\" " + Myfile4.Name + ".");
                    messagedialog.Commands.Add(new UICommand("Ok"));
                    await messagedialog.ShowAsync();
                }
            }
        ...
        private async void AppBarButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            await FileIO.WriteTextAsync(UPLOADFile, "<!-- ======================================МОДУЛЬ \"НАШИ КЛИЕНТЫ\"======================================== -->\r\n");
            await FileIO.AppendTextAsync(UPLOADFile, "<div class=\"container marketing\"><h3 style=\"color:" + TextBoxZagolovokColor.Text + ";\">НАШИ КЛИЕНТЫ</h3>\r\n");
